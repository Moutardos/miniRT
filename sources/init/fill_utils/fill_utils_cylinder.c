...
/*   Updated: 2024/04/09 20:37:00 by ekhaled          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
			...
			t_camera *camera, t_light *light)
{
	...
	fill_plane_utils(&cylinder->utils.induced_plane1, camera, light);
	fill_plane_utils(&cylinder->utils.induced_plane2, camera, light);
}

void	fill_cylinder_utils(t_cylinder *cylinder,
			t_camera *camera, t_light *light)
{
	fill_cylinder_disks_utils(cylinder, camera, light);
	fill_cylinder_tube_camera_utils(cylinder, camera);
	fill_cylinder_tube_light_utils(cylinder, light);
}
